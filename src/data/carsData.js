const carsData = [
    {
        ...
        location: "Iran",
        price: 40000,
        description: 'این نوع طراحی طبق گفته مهندسان سایپا الگو برداری شده از چهره یوز ایرانی است. همچنین دیگر تفاوت این خودرو مربوط به فرم و طراحی جلوپنجره و سپر خودرو است که باعث شده تا این کوییک جدید چهره‌ای تهاجمی تر داشته باشد.همچنین در تیپ G نسبت به تیپ S از رینگ های آلومینیومی و شیشه های دودی استفاده شده است. متاسفانه همانطور که اشاره کردیم دیگر نماهای این خودرو تغییری نداشته‌اند.تفاوت بعدی این تیپ با تیپ S و تیپ های قدیمی کوییک به داخل کابین مربوط می شود. هنگام ورود به کابین این خودرو با یک داشبورد کاملا جدید و نسبتا بروز مواجه می شویم.پنل میانی داشبورد نسبت به تمامی تیپ های کوییک تغییر کرده و در بالاترین قسمت آن یک نمایشگر لمسی نسبتا بزرگ تعبیه شده است. زیر نمایشگر خروجی های هوای تهویه مطبوع خودرو قرار گرفته که ظاهری دایره‌ای شکل دارند.پس از آن بخش تنظیمات تهویه مطبوع دیجیتالی خودرو قرار گرفته است. انتهای پنل میانی نیز چند کلید و یک خروجی فندکی و usb تعبیه شده است. غربیلک فرمان مانند کوییک S طراحی D کات و اسپرتی دارد که برخلاف تیپ S دکمه های کنترلی کروز کنترل و سیستم مولتی مدیا نیز بر روی فرمان قرار گرفته‌اند. پشت آمپر خودرو نیز شبیه به تیپ S کوییک شده و طراحی بروزی دارد.',
